...
import com.mycompany.JDialogs.UpUser;
...
public class Users extends javax.swing.JPanel {
    ...
    if (selectedRows.length > 0) {
        ...
        if (selectedRows.length == 1) {
            message = "¿Estás seguro de que deseas eliminar al estudiante seleccionado?";
        } else {
            message = "¿Estás seguro de que deseas eliminar a los " + selectedRows.length + " estudiantes seleccionados?";
        }
        ...
        JOptionPane.showMessageDialog(
            this, 
            "No has seleccionado ningún estudiante para eliminar.", 
            "Advertencia", 
            JOptionPane.WARNING_MESSAGE
        );
    }
    ...
    private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            UpUser create = new UpUser(parentFrame, true, wanted);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        JFrame parentFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
        UpUser create = new UpUser(parentFrame, true, null);
        create.setLocationRelativeTo(parentFrame);
        create.setVisible(true);
        LoadStudents();
    ...
    private void historyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_historyButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            parentFrame.ShowJPanel(new HistoryStudent(wanted));
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "No has seleccionado ningún estudiante para modificar.", "Advertencia", javax.swing.JOptionPane.WARNING_MESSAGE);
        }
