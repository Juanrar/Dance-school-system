...
public class UpTeacher extends javax.swing.JDialog {
    private Teachers teacher = null;

    public UpTeacher(java.awt.Frame parent, boolean modal, Teachers teacher) {
        super(parent, modal);
        ...
        if(teacher != null){
            ...
            fillStudentData();
            Title.setText("Modificar Profesor");
            button.setText("Modificar");
        }
        else{
            Title.setText("Nuevo Profesor");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpTeacher dialog = new UpTeacher(new javax.swing.JFrame(), true, null);
    ...
    private void fillStudentData() {
        ...
        DNIText.setText(teacher.getDNI());
        phoneText.setText(teacher.getPhone_number());
    }
}
